...
const features: Feature[] = [
  {
    ...
    videoUrl:
      "https://res.cloudinary.com/dg0cwy8vx/video/upload/v1761812196/WiseNotes/1_WiseNotes_NotesFunctionality_dsao03.mp4",
  },
  {
    title: "Adding New Note",
    description: "",
    videoUrl:
      "https://res.cloudinary.com/dg0cwy8vx/video/upload/v1761812119/WiseNotes/2_WiseNotes_NewNote_dmvb8r.mp4",
  },
  {
    title: "Notebooks",
    description: "",
    ...
    <>
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {userInterfaceFeatures.map((feature) => (
            <FeatureTemplate
              key={feature.videoUrl}
              title={feature.title}
              description={feature.description}
