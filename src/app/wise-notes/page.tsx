...
export default function Page() {
  return (
    <>
      <div className="px-[5%] lg:px-[18%] pt-8">
        <div className="h-screen">
          <div className="flex justify-between items-center mx-auto bg-white dark:bg-gray-900 p-4 rounded-lg shadow-lg box-border">
            <Link
              className={
                "transition hover:border-b-1 hover:border-b-black flex gap-2 w-fit"
              }
              href={"/"}
            >
          ...
          <div className="flex flex-col gap-8 text-center items-center justify-center h-[calc(100vh-100px)]">
            ...
            <p className="md:w-[75%] text-md md:text-lg text-balance tracking-wide">
              ...
              <span className="font-bold">MongoDB</span> in the back-end. It has
              a feature where the user can query the integrated model about
              their notes. It can synthesize and summarize notes according to
              users&apos; needs. This application implements this basic idea, as
              it expands and improve, this system can be used as a research
              tool, a knowledge base for organizations, and as a database for
              expert systems.
            </p>
